      ...
      {inventario.length === 0 ? (
        ...
        <div>
          ...
          <div className="mb-4">
            <Input
              type="text"
              placeholder="🔍 Buscar refacción por nombre o código..."
              value={busqueda}
          ...
          <h3 className="text-base font-bold text-slate-700 mb-3">
            ...
            <span className="ml-2 text-xs font-semibold bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full">{filtrados.length}</span>
          </h3>
