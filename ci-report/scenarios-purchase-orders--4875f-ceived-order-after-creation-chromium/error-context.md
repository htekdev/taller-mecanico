...
- Name: scenarios/purchase-orders.spec.ts >> Purchase Orders >> edit received order after creation
- Location: e2e/tests/scenarios/purchase-orders.spec.ts:55:7

# Error details

```
Error: locator.count: Unexpected token "=" while parsing css selector ".border.rounded-xl:has(text=/OC-|Orden/), [data-testid="orden-item"]". Did you mean to CSS.escape it?
```
        ...
        - generic [ref=e67]:
          ...
          - generic [ref=e69]:
            ...
            - generic [ref=e101]:
              ...
              - button [ref=e105]
            - paragraph [ref=e107]: ⚠️ Selecciona un proveedor para continuar.
