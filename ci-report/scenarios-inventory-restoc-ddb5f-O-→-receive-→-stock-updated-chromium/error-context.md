...
- Name: scenarios/inventory-restock-flow.spec.ts >> Inventory Restock Flow >> full restock cycle: low stock → PO → receive → stock updated
- Location: e2e/tests/scenarios/inventory-restock-flow.spec.ts:26:7
