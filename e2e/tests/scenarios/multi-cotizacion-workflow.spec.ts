...
test.describe('Multi-Cotización Workflow', () => {
  ...
  // Resilience fix (issue #138): test.slow() + retries:1 absorb Supabase cold-start on
  // cotización create + navigation. Warm-up in global-setup.ts pre-warms DB connections.
