...
- Name: edge-cases\concurrent-operations.spec.ts >> Concurrent Operations >> rapid module switching does not crash
- Location: e2e\tests\edge-cases\concurrent-operations.spec.ts:16:7
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`cle1::srnvz-1782625632380-83ef62a32b4d`"
